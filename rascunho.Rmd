...
set.seed(2024)
dsel = dsel[sample(c(1:15706), 200),]
...
```{r}
modelo = glm(sobremesa~calorias+proteina+gordura+sodio, family = binomial(),
             data = dsel)
